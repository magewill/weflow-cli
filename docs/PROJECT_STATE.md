...
> Last reviewed: 2026-09-19 (sync and media coverage added). This is the current maintenance snapshot, not a release note. Keep it factual and update it with meaningful project changes.

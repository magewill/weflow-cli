...
> Last reviewed: 2026-09-20 (message-column variation, window pushdown, native passphrase verification added). This is the current maintenance snapshot, not a release note. Keep it factual and update it with meaningful project changes.
